...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='resource',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='operational_exceptions', to='resource_manager.resource'),
        ),
        migrations.AddField(
            model_name='operationalexception',
            name='updated_by',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='resource_calendar.weeklyshifttemplate'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='resource_calendar.operationalexceptiontype'),
        ),
        migrations.AddField(
            model_name='historicaloperationalexception',
            name='resource',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='resource_manager.resource'),
        ),
        migrations.AddField(
            model_name='historicaloperationalexception',
            name='updated_by',
