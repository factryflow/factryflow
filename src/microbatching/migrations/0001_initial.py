# Generated by Django 4.2.7 on 2024-10-17 13:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_fields', models.JSONField(blank=True, default=dict, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_%(class)s_objects', to=settings.AUTH_USER_MODEL)),
                ('microbatch_task_flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_flows', to='microbatching.microbatchtaskflow')),
        ...
        migrations.AddField(
            ...
            name='end_rule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flow_end_rule', to='microbatching.microbatchrule'),
        ),
        migrations.AddField(
            model_name='microbatchflow',
            name='start_rule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flow_start_rule', to='microbatching.microbatchrule'),
        ),
        migrations.AddField(
            model_name='microbatchflow',
            name='updated_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('microbatch_task_flow', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='microbatching.microbatchtaskflow')),
